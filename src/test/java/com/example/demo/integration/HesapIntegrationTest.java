...
class HesapIntegrationTest {
        ...
        static void registerProperties(DynamicPropertyRegistry registry) {
                registry.add("spring.datasource.url", () -> "jdbc:postgresql://localhost:5432/bankdb_test");
                registry.add("spring.datasource.username", () -> "postgres");
                registry.add("spring.datasource.password", () -> "Filiz123.");
        }
        ...
        void hesapOlusturVeParaYatir() throws Exception {
                ...
                assertNotNull(olusturulanHesap.getHesapSahipKimlikNo());
